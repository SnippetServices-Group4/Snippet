...
public class SnippetServiceTests {
  ...
  //        .thenReturn(FullResponse.create("Permission granted", "permission", snippetId,
  // HttpStatus.OK));
  //
  ...
  //    // Mocking
  //    when(snippetRepository.findById(anyLong())).thenReturn(Optional.of(snippet));
  //    when(permissionService.deletePermissions(anyLong(), anyString()))
  //        .thenReturn(FullResponse.create("Permission deleted", "permission", 1L, HttpStatus.OK));
  //
  //    // Test execution
