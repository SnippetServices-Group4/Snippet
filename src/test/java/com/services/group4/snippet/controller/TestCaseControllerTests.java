...
public class TestCaseControllerTests {
  ...
  public void setup() {
    ...
    testCaseResponseDto =
        new TestCaseResponseDto(1L, "Test Case", List.of("input1"), List.of("output1"));
    testCaseResponseStateDto =
        new TestCaseResponseStateDto(
            1L, "Test Case", TestState.NOT_STARTED, List.of("input1"), List.of("output1"));
  }
  ...
  public void testGetAllTestCases() throws Exception {
    List<TestCaseResponseStateDto> testCaseList =
        List.of(
            new TestCaseResponseStateDto(
                1L, "Test Case 1", TestState.NOT_STARTED, List.of("input1"), List.of("output1")),
            new TestCaseResponseStateDto(
                2L, "Test Case 2", TestState.NOT_STARTED, List.of("input2"), List.of("output2")));

    when(testCaseService.getTestCase(anyLong()))
        .thenReturn(
            FullResponse.create(
                "Test cases found successfully", "testCases", testCaseList, HttpStatus.OK));
