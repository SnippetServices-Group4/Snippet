...
public class SnippetController {
  ...
  public SnippetController(
      SnippetService snippetService, PermissionService permissionService) {
  ...
  public ResponseEntity<String> createSnippet(@RequestBody @Valid SnippetDto snippetDto) {
    try {
      ...
      return new ResponseEntity<>("Something went wrong creating the Snippet",HttpStatus.INTERNAL_SERVER_ERROR);
    }
  }
  ...
  public ResponseEntity<String> getSnippet(@PathVariable Long id) {
    ...
    return snippet.map(s -> new ResponseEntity<>(s, HttpStatus.OK))
